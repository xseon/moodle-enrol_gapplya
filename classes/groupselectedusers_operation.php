...
class enrol_gapplya_groupselectedusers_operation extends enrol_bulk_enrolment_operation {
    ...
    public function get_title() {
        return get_string('groupselectedusers', 'enrol_gapplya');
    }
    ...
    public function process(course_enrolment_manager $manager, array $users, stdClass $properties) {
        ...
        if (!has_capability("enrol/gapplya:manage", $manager->get_context())) {
            return false;
        }
     ...
     * @return enrol_gapplya_groupselectedusers_form
     */
    public function get_form($defaultaction = null, $defaultcustomdata = null) {
        return new enrol_gapplya_groupselectedusers_form($defaultaction, $defaultcustomdata);
    }
}
